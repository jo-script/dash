...
import { dataOrders } from '../../new-order/dataOrder.js';
...
const OrderDetail = ({ params }) => {
  const { id } = params;
  const prepare = dataOrders.find((prepare) => prepare.id === parseInt(id));
        ...
        <table class="w-full text-sm text-start rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr class="bg-white text-black">
              ...
              <td class=" text-start px-6 py-4">{prepare.numberOrders}</td>
            </tr>
            ...
            <tr class="bg-white text-black">
              ...
              <td class="px-6 py-4">{prepare.numberProducts}</td>
            </tr>
            <tr class="bg-gray-200 text-black">
              <th scope="row" class="text-start px-6 py-4 font-medium ">عدد القطع</th>
              <td class="px-6 py-4">{prepare.numberPieces}</td>
            </tr>
