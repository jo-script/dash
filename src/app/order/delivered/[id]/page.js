...
const OrderDetail = ({ params }) => {
  const { id } = params;
  const delivered = dataDelivered.find((delivered) => delivered.id === parseInt(id));
        ...
        <table class="w-full text-sm text-start rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr class="bg-white text-black">
              ...
              <td class=" text-start px-6 py-4">{delivered.numberOrders}</td>
            </tr>
            ...
            <tr class="bg-white text-black">
              ...
              <td class="px-6 py-4">{delivered.numberProducts}</td>
            </tr>
            <tr class="bg-gray-200 text-black">
              <th scope="row" class="text-start px-6 py-4 font-medium ">عدد القطع</th>
              <td class="px-6 py-4">{delivered.numberPieces}</td>
            </tr>
