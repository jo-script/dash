  ...
  return (
    <div className='w-full flex flex-col items-center gap-3 mt-10'>
      ...
      {dataOrders.map((order) => (
        <div key={order.id} className='w-[98%] h-[120px] max-[750px]:h-auto rounded-md bg-[#dae6f2] border shadow-sm  flex items-center justify-around gap-4 max-[750px]:overflow-scroll max-[750px]:px-5  hover:scale-[1.01] transition-[all_.02s]'>
