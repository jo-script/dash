      ...
      <div className="w-full flex items-start justify-evenly gap-8 flex-wrap ">
        ...
        <div className="flex flex-col items-start gap-3  ">
          <div className="flex items-center justify-center gap-3 ">
            <h1 className="font-bold text-[18px] text-[#224971]">إسم ألمنتج:</h1>
            <p className=" text-[19px] text-[#3a5069]">{product.nameArabic}</p>
          </div>
          <div className="flex items-center justify-center gap-3">
            <h1 className="font-bold text-[18px] text-[#224971]" >إسم ألمنتج بالانجليزيه:</h1>
            <p className=" text-[19px] text-[#3a5069]">{product.nameEnglish}</p>
          </div>
          <div className="flex items-center justify-center gap-3">
            <h1 className="font-bold text-[18px] text-[#224971]">الكمية:</h1>
            <p className=" text-[19px] text-[#3a5069]">{product.amount}</p>
          </div>
          <div className="flex items-center justify-center gap-3">
            <h1 className="font-bold text-[18px] text-[#224971]">سعر المنتج :</h1>
            <p className=" text-[19px] text-[#3a5069]">{product.price}$</p>
          </div>
          <div className="flex items-center justify-center gap-3">
            <h1 className="font-bold text-[18px] text-[#224971]"> تفاصيل المنتج بالعربية:</h1>
            <p className=" text-[19px] text-[#3a5069]">{product.detailsArabic}</p>
          </div>
          <div className="flex items-center justify-center gap-3">
            <h1 className="font-bold text-[18px] text-[#224971]">تفاصيل المنتج بالانجليزية :</h1>
            <p className=" text-[19px] text-[#3a5069]">{product.detailsEnglish}</p>
          </div>
          <div className="flex items-center justify-center gap-3">
            <h1 className="font-bold text-[18px] text-[#224971]"> التصنيف الرئيسي:</h1>
            <p className=" text-[19px] text-[#3a5069]">{product.mainCategory}</p>
          </div>
          <div className="flex items-center justify-center gap-3">
            <p className=" font-bold  text-[18px] text-[#224971]"> ألوزن:</p>
